 ...
 */
export const encrypt = (data: Uint8Array, key?: CryptoKey) => {
  if (!key) {
 ...
 */
export const decrypt = (data: Uint8Array, key?: CryptoKey) => {
  if (!key) {
    return /** @type {PromiseLike<Uint8Array>} */ (promise.resolve(data))
  }
 ...
 */
export const decryptJson = (data: Uint8Array, key?: CryptoKey): PromiseLike<Object> =>
